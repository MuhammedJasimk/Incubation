...
function ApplicationList() {
    ...
    useEffect(()=>{
        try {
            axios.get('http://localhost:8080/api/admin/applicationList').then((response)=>{
       ...
       return (
        <div>
            ...
            <h1 className='mb-7 font-bold text-2xl text-stone-600'>Application List</h1>
                    ...
                    <tbody>
                      ...
                      return(
                        <tr className='bg-white text-[#000] border-b dark:bg-gray-800 dark:border-gray-700 ' key={index}>
                            ...
                            <td className='py-3 px-6 text-green-700 font-bold'>{item.status}</td>
